...
public:
	...
	TEST_METHOD(NormalTest2) {
		...
		Assert::AreEqual(4, s.count_result());
	}
	...
	/* 两个线段的端点为唯一交点
	*/
	TEST_METHOD(TestSegement1) {
		Solution s;
		s.add_component("S 0 0 1 1");
		s.add_component("S 1 1 2 2");

		Assert::AreEqual(1, s.count_result());
	}

	TEST_METHOD(TestSegement2) {
		Solution s;
		s.add_component("S 0 0 0 1");
		s.add_component("S 0 0 0 -1");
	...
	/* 线段与射线的端点为交点
	*/
	TEST_METHOD(TestSegementWithRay1) {
		Solution s;
		s.add_component("S 0 0 1 0");
		s.add_component("R 0 0 -1 0");

		Assert::AreEqual(1, s.count_result());
	}

	TEST_METHOD(TestSegementWithRay2) {
		Solution s;
		s.add_component("S 0 0 0 1");
		s.add_component("R 0 0 0 -1");
	...
	/* 线段与圆交点为端点
	*/
	TEST_METHOD(TestSegmentWithCircle1) {
		Solution s;
		s.add_component("C 0 0 1");
		s.add_component("S -1 0 1 0");

		Assert::AreEqual(2, s.count_result());
	}

	TEST_METHOD(TestSegmentWithCircle2) {
		Solution s;
		s.add_component("C 0 0 1");
		s.add_component("S 0 1 0 -1");
	...
	/* 射线与圆
	*/
	TEST_METHOD(TestRayWithCircle1) {
		Solution s;
		s.add_component("C 0 0 1");
		s.add_component("R 1 0 2 0");

		Assert::AreEqual(1, s.count_result());
	}

	TEST_METHOD(TestRayWithCircle2) {
		Solution s;
		s.add_component("C 0 0 1");
		s.add_component("R 0 1 0 2");
	...
	/* 射线与射线
	*/
	TEST_METHOD(TestRayWithRay1) {
		Solution s;
		s.add_component("R 0 1 0 -1");
		s.add_component("R 0 1 0 2");

		Assert::AreEqual(1, s.count_result());
	}

	TEST_METHOD(TestRayWithRay2) {
		Solution s;
		s.add_component("R 1 0 2 0");
		s.add_component("R 1 0 0 0");
	...
	/* 三个图形一个交点
	*/
	TEST_METHOD(TestThreeComponentCross1) {
		Solution s;
		s.add_component("C 0 0 1");
		s.add_component("R 1 0 2 1");
		s.add_component("R 1 0 2 -1");

		Assert::AreEqual(1, s.count_result());
	}

	TEST_METHOD(TestThreeComponentCross2) {
		Solution s;
		s.add_component("C 1 0 1");
		s.add_component("C -1 0 1");
		s.add_component("C 0 1 1");

		Assert::AreEqual(3, s.count_result());
	}

	TEST_METHOD(TestThreeComponentCross3) {
		Solution s;
		s.add_component("C 1 0 1");
		s.add_component("C -1 0 1");
		s.add_component("C 0 1 1");
